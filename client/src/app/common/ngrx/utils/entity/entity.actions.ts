...
import { NgrxItemActions } from '../ngrx/ngrx-item';
import { EntityState } from './entity.states';
import { Entity } from '../../../../../../../common/interfaces';

export class EntityActions<T extends Entity> extends NgrxItemActions<EntityState<T>> {
  constructor(protected state: EntityState<T>, protected payload: any) {
    super(state, payload);
  }
